...
echo.
echo Add/install the Plop Boot Manager Installer to the Windows boot menu
...
set ENTRYNAME=Install/Remove the Plop Boot Manager [MBR]

echo Add the Plop Boot Manager Install program to the Windows boot menu?
set /p Choice={y,n}
