...
#define PACKAGE_STRING "sgminer 5.6.1-nicehash"
...
#define PACKAGE_VERSION "5.6.1-nicehash"
...
/* Micro version */
#define SGMINER_MINOR_SUBVERSION 1

/* Minor version */
#define SGMINER_MINOR_VERSION 6

/* Path to sgminer install */
#define SGMINER_PREFIX "/usr/local/bin"

/* Revison */
#define SGMINER_REVISON nicehash
